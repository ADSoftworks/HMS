...
["", "UploadListener.class.dart", , U, {
  "^": "",
  UploadListener: {
    "^": "Object;",
    clickMade$1: [function($event) {
      P.print("Clicky clicky!");
    }, "call$1", "get$clickMade", 2, 0, 6],
    UploadListener$0: function() {
      var t1 = J.get$onClick$x(document.querySelector("#upload_button"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(this.get$clickMade()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      P.print("Dart Upload Listener initialized");
    }
  }
}],
...
["", "upload_handling.dart", , D, {
  "^": "",
  main: [function() {
    P.print("Dart!");
    var t1 = new U.UploadListener();
    t1.UploadListener$0();
    $.uploadlistener = t1;
...
//# sourceMappingURL=upload_handling.dart.js.map
{
  var message =
...
function dart_precompiled($collectedClasses) {
  ...
  UploadListener.builtin$cls = "UploadListener";
  if (!"name" in UploadListener)
    UploadListener.name = "UploadListener";
  $desc = $collectedClasses.UploadListener;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UploadListener.prototype = $desc;
